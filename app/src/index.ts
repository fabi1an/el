...
const createMainWindow = async () => {
  ...
  const onBeforeRequest = (details: Electron.OnBeforeRequestListenerDetails, callback: (response: Electron.Response) => void) => {
    if (splashWindow) {
  ...
  mainWindow!.webContents.session.webRequest.onBeforeRequest({ urls: ["*://*/*"] }, onBeforeRequest);
  mainWindow!.webContents.session.webRequest.onCompleted({ urls: ["*://*/*"] }, onCompleted);
};
